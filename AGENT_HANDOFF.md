...
| v2.20.0 | 2026-08-22 | 章节精讲样式1:1还原+三科统一：移除本章概览/重难点，信息条新样式(基础+页码+N/18知识点+重点一般计数)，筛选药丸带计数+渐变选中态，分类卡片可折叠(彩色左边框)，知识点颜色标签+背景色区分，底部测验按钮，从13015同步到02324和13003 |
...
> 以下为截至 v2.18.3 的待办优先级，供新 Agent 参考。

...
```json
{
  ...
  "type": "self-study",
  "renderMode": "content",
  "contentUrl": "自考学习/备考科目/02324离散数学/02324离散数学-目录与知识框架.html?subject=13003"
}
```

> 三科知识框架共用 `02324离散数学-目录与知识框架.html` 单页（方案A-1），通过 `?subject=13015|02324|13003` 参数区分科目；各科掌握度数据存独立 localStorage 键（`ss_mastery_{科目代码}`）。
